...
int CALLBACK WinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow )
{
  ...
  std::cout << "WinMain="<<nCmdShow<<std::endl;
...
std::cout << "message2="<<4<<std::endl;
  ...
  HINSTANCE hKernelDLL = LoadLibrary( "kernel32.dll" );
    std::cout << "hKernelDLL="<<hKernelDLL<<std::endl;
  ...
  {
    std::cout << "SetDefaultDllDirectories="<<SetDefaultDllDirectories<<std::endl;
    std::cout << "AddDllDirectory="<<AddDllDirectory<<std::endl;
